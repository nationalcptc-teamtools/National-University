...
```shell-session
anasec@htb[/htb]$ sudo nc -lvnp 80
listening on [any] 80 ...
```
...
```shell-session
anasec@htb[/htb]$ mkdir /tmp/tmpserver
anasec@htb[/htb]$ cd /tmp/tmpserver
anasec@htb[/htb]$ vi index.php #at this step we wrote our index.php file
anasec@htb[/htb]$ sudo php -S 0.0.0.0:80
...
![[Pasted image 20240625195459.png]]

![[Pasted image 20240625195849.png]]

![[Pasted image 20240625195916.png]]

![[Pasted image 20240625195959.png]]

![[Pasted image 20240625200011.png]]
