...
```shell-session
anasec@htb[/htb]$ git clone https://github.com/s0md3v/XSStrike.git
anasec@htb[/htb]$ cd XSStrike
anasec@htb[/htb]$ pip install -r requirements.txt
anasec@htb[/htb]$ python xsstrike.py
...
```shell-session
anasec@htb[/htb]$ python xsstrike.py -u "http://SERVER_IP:PORT/index.php?task=test" 
