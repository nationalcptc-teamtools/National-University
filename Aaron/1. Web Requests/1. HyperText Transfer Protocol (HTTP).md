...
```shell-session
anasec@htb[/htb]$ curl inlanefreight.com
...
```shell-session
anasec@htb[/htb]$ curl -O inlanefreight.com/index.html
anasec@htb[/htb]$ ls
index.html
```
...
```shell-session
anasec@htb[/htb]$ curl -s -O inlanefreight.com/index.html
```
