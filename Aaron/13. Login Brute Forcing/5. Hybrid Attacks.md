...
![](https://academy.hackthebox.com/storage/modules/57/2.png)
...
![](https://academy.hackthebox.com/storage/modules/57/3.png)
...
```shell-session
anasec@htb[/htb]$ wget https://raw.githubusercontent.com/danielmiessler/SecLists/refs/heads/master/Passwords/darkweb2017-top10000.txt
```
...
```shell-session
anasec@htb[/htb]$ grep -E '^.{8,}$' darkweb2017-top10000.txt > darkweb2017-minlength.txt
```
...
```shell-session
anasec@htb[/htb]$ grep -E '[A-Z]' darkweb2017-minlength.txt > darkweb2017-uppercase.txt
```
...
```shell-session
anasec@htb[/htb]$ grep -E '[a-z]' darkweb2017-uppercase.txt > darkweb2017-lowercase.txt
```
...
```shell-session
anasec@htb[/htb]$ grep -E '[0-9]' darkweb2017-lowercase.txt > darkweb2017-number.txt
```
...
```shell-session
anasec@htb[/htb]$ wc -l darkweb2017-number.txt
...
![](https://academy.hackthebox.com/storage/modules/57/4.png)
